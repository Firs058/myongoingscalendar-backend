...
public class UserTitleEntity implements Serializable {
    ...
    @SequenceGenerator(name = "users_titles_seq", sequenceName = "users_titles_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "users_titles_seq")
    private Long id;
